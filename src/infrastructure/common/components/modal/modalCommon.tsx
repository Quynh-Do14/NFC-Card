...
import UploadImageProduct from '../input/upload-img-product';
            ...
            <div>
                ...
                <Row gutter={[30, 30]} justify={"center"} className='mb-7 sm:p-4 p-0'>
                    <Col xs={12} sm={12} lg={12}>
                        <div className='rounded-[15px] bg-[#f3f3f1] border-[1px] border-blue-100 h-full min-w-[110px] min-h-[110px] relative'>
                            <UploadImageProduct
                                label={'Tiêu đề'}
                                attribute={'coverImg'}
                                isRequired={true}
                                setData={setData}
                                dataAttribute={data.coverImg}
                                validate={validate}
