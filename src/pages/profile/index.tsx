...
import EidtProfileComponent from './components/edit';
...
const ProfilePage = () => {
    ...
    return (
        <MainLayout>
            <div className='profile-container h-full flex-1 overflow-auto'>
                <div className='flex flex-col gap-6 padding-link'>
                    <InfoProfileComponent />
                    <EidtProfileComponent
                        data={dataProfile}
